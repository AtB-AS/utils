...
export const TravelRightType = z.object({
  ...
  startDateTime: z.date(),
  endDateTime: z.date(),
  usageValidityPeriodRef: z.string().nullish(),
  userProfileRef: z.string().nullish(),
  authorityRef: z.string(),
  tariffZoneRefs: z.array(z.string()).nullish(),
  fareZoneRefs: z.array(z.string()).nullish(),
  startPointRef: z.string().nullish(),
  endPointRef: z.string().nullish(),
  direction: z.nativeEnum(TravelRightDirection).nullish(),
  maximumNumberOfAccesses: z.number().nullish(),
  numberOfUsedAccesses: z.number().nullish(),
  usedAccesses: z.array(UsedAccessType).nullish(),
  schoolName: z.string().nullish(),
  travelerName: z.string().nullish(),
});
